...
<a href=" "> <img src="https://img.shields.io/badge/Version-3.0.13_beta3-important" /></a>
...
``` groovy
dependencies {
  implementation 'com.cometchat:cometchat-pro-android-dependencies:3.0.13-beta3'
}
```
</li><li>
...
```groovy
dependencies {
  implementation 'com.cometchat:pro-android-chat-sdk:3.0.13-beta3'
}
```
