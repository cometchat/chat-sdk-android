...
<a href=" "> <img src="https://img.shields.io/badge/Version-2.2.2beta1-important" /></a>
...
``` groovy
dependencies {
  implementation 'com.cometchat:cometchat-pro-android-dependencies:2.2.2-beta1'
}
```
</li><li>
...
```groovy
dependencies {
  implementation 'com.cometchat:pro-android-chat-sdk:2.2.2-beta1'
}
```
