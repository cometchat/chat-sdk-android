...
<a href=" "> <img src="https://img.shields.io/badge/Version-4.0.5_beta1-important" /></a>
...
``` groovy
dependencies {
  implementation 'com.cometchat:chat-sdk-android-dependencies:4.0.5_beta1'
}
```
</li><li>
...
```groovy
dependencies {
  implementation 'com.cometchat:chat-sdk-android:4.0.5_beta1'
}
```
