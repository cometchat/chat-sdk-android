...
public class AIAssistantMessage extends BaseMessage {
    ...
    public static AIAssistantMessage fromJson(JSONObject jsonObject) {
        ...
        try {
            ...
            BaseMessage.applyPinSaveAttributes(aiAssistantMessage, jsonObject);
            com.cometchat.chat.utils.ThreadParser.applyThreadAttributes(aiAssistantMessage, jsonObject);
