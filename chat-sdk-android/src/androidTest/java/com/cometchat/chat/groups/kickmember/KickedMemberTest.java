package com.cometchat.chat.groups.kickmember;
...
public class KickedMemberTest {

    private final int TEST_CASE_TIMEOUT = 5;

    @Test
    public void a1_loggedInWithKickedUser() throws InterruptedException{
    ...
    @Test
    public void a2_groupEntryRemovedInConversationsForKickedMemberGroupCheck() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void a3_sendMessageToPublicGroupByKickedMember() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void a4_fetchMessagesByKickedMemberForGroup() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void a5_fetchGroupMembersByKickedMemberForGroup() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
