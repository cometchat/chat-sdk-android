...
public class CreateGroupTest {
    ...
    public void a5_createdGroupEntryInConversationsForNewlyCreatedPublicGroupCheck() throws InterruptedException{
        ...
        conversationsRequest.fetchNext(new CometChat.CallbackListener<List<Conversation>>() {
            ...
            public void onSuccess(List<Conversation> conversations) {
                ...
                AssertHelper.assertTrue(methodName + " validate conversation list : " + validateConversationList , validateConversationList.equalsIgnoreCase(""));
    ...
    public void a6_sendMessageToNewlyCreatedPublicGroup() throws InterruptedException{
        ...
        CometChat.sendMessage(textMessage, new CometChat.CallbackListener<TextMessage>() {
            ...
            public void onSuccess(TextMessage receivedTextMessage) {
                Assert.assertNotNull(methodName + " Received Message Null Check", receivedTextMessage);
    ...
    public void a8_fetchMessagesForNewlyCreatedPublicGroup() throws InterruptedException{
        ...
        messagesRequest.fetchPrevious(new CometChat.CallbackListener<List<BaseMessage>>() {
            ...
            public void onSuccess(List<BaseMessage> receivedMessages) {
                Assert.assertNotNull(methodName + " Received Message List Null Check", receivedMessages);
                AssertHelper.assertTrue(methodName + " Received Message List Limit Check", receivedMessages.size() <= 30);
                AssertHelper.assertTrue(methodName + " Received Message List Size", receivedMessages.size() == 1);
    ...
    @Test
    public void d5_createPublicGroupWithIconAndDescriptionShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void d6_createPublicGroupWithEmptyIconAndEmptyDescriptionShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void d7_createPublicGroupWithIconAndDescriptionAndMetadataShouldReturnSuccess() throws InterruptedException, JSONException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_NAME, System.currentTimeMillis()),
    ...
    // Private groups with icon, description and metadata

    @Test
    public void d9_createPrivateGroupWithIconAndDescriptionShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void e1_createPrivateGroupWithEmptyIconAndEmptyDescriptionShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void e2_createPrivateGroupWithIconAndDescriptionAndMetadataShouldReturnSuccess() throws InterruptedException, JSONException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_NAME, System.currentTimeMillis()),
    ...
    //Password Group with icon, description, metadata


    @Test
    public void e4_createPasswordGroupWithIconAndDescriptionShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void e5_createPasswordGroupWithEmptyIconAndEmptyDescriptionShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void e6_createPasswordGroupWithIconAndDescriptionAndMetadataShouldReturnSuccess() throws InterruptedException, JSONException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_GUID, System.currentTimeMillis()),
                String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_NAME, System.currentTimeMillis()),
    ...
    @Test
    public void e8_createPublicGroupWithTagsShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_GUID, "withtags"),
                String.format(CometChatTestConstants.DEFAULT_PUBLIC_GROUP_NAME, "_"+" withtags"),
                CometChatConstants.GROUP_TYPE_PUBLIC,
                null);
        ...
        CometChat.createGroup(group, new CometChat.CallbackListener<Group>() {
            ...
            public void onSuccess(Group createdGroup) {
                ...
                String validateGroup = TestUtils.validateGroup(createdGroup, true);
                AssertHelper.assertTrue(methodName + " Validate Group : " + validateGroup, validateGroup.equalsIgnoreCase(""));
                AssertHelper.assertTrue(methodName + "Validate Tags" , createdGroup.getTags().contains(CometChatConstants.GROUP_TYPE_PUBLIC));
                countDownLatch.countDown();
            }
    ...
    @Test
    public void e9_createPasswordGroupWithTagsShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_GUID, ""+"withtags"),
                String.format(CometChatTestConstants.DEFAULT_PASSWORD_GROUP_NAME, ""+" withtags"),
                CometChatConstants.GROUP_TYPE_PASSWORD,
                CometChatTestConstants.DEFAULT_PASSWORD_GROUP_PASSWORD);
        List<String> tags = new ArrayList<>();
        ...
        CometChat.createGroup(group, new CometChat.CallbackListener<Group>() {
            ...
            public void onSuccess(Group createdGroup) {
                ...
                String validateGroup = TestUtils.validateGroup(createdGroup, true);
                AssertHelper.assertTrue(methodName + " Validate Group : " + validateGroup, validateGroup.equalsIgnoreCase(""));
                AssertHelper.assertTrue(methodName + "Validate Tags" , createdGroup.getTags().contains(CometChatConstants.GROUP_TYPE_PASSWORD));
                countDownLatch.countDown();
            }
    ...
    @Test
    public void f1_createPrivateGroupWithTagsShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Group group = new Group(String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_GUID, ""+"withtags"),
                String.format(CometChatTestConstants.DEFAULT_PRIVATE_GROUP_NAME, ""+" withtags"),
                CometChatConstants.GROUP_TYPE_PRIVATE,
                null);
        List<String> tags = new ArrayList<>();
        ...
        CometChat.createGroup(group, new CometChat.CallbackListener<Group>() {
            ...
            public void onSuccess(Group createdGroup) {
                ...
                String validateGroup = TestUtils.validateGroup(createdGroup, true);
                AssertHelper.assertTrue(methodName + " Validate Group : " + validateGroup, validateGroup.equalsIgnoreCase(""));
                AssertHelper.assertTrue(methodName + "Validate Tags" , createdGroup.getTags().contains(CometChatConstants.GROUP_TYPE_PRIVATE));
                countDownLatch.countDown();
            }
