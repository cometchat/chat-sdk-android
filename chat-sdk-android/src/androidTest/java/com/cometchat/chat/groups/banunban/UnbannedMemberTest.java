...
public class UnbannedMemberTest {

    private final int TEST_CASE_TIMEOUT = 5;

    @Test
    public void a1_loggedInWithUnbannedUser() throws InterruptedException{
    ...
    @Test
    public void a2_groupEntryNotAddedInConversationsForUnbannedMemberGroupCheck() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void a3_sendMessageToPublicGroupByUnbannedMember() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void a4_fetchMessagesByUnbannedMemberForGroup() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void b7_groupEntryInConversationsForJoinedMember() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        ConversationsRequest conversationsRequest = new ConversationsRequest.ConversationsRequestBuilder().build();
        conversationsRequest.fetchNext(new CometChat.CallbackListener<List<Conversation>>() {
    ...
    @Test
    public void b8_sendMessageInJoinedGroupShouldReturnSuccess() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void b9_fetchMessagesForPublicGroup() throws InterruptedException {
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void c1_fetchGroupMembersByUnbannedJoinedMemberForPublicGroup() throws InterruptedException{
        final String methodName = TestUtils.getMethodName();
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        GroupMembersRequest groupMembersRequest = new GroupMembersRequest.GroupMembersRequestBuilder(TestPreferenceHelper.getLastPublicGroupGUID()).build();
        groupMembersRequest.fetchNext(new CometChat.CallbackListener<List<GroupMember>>() {
